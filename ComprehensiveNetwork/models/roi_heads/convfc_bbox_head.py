...
class ConvFCBBoxHead(nn.Module):
    ...
    def __init__(self, in_channels=256, conv_out_channels=256, fc_out_channels=1024, 
                 roi_feat_size=7, num_classes=80, with_avg_pool=False,
                 num_shared_convs=0, num_shared_fcs=0, num_cls_convs=0, num_cls_fcs=0,
        ...
        self.shared_convs, self.shared_fcs, last_layer_dim = \
            self._add_conv_fc_branch(self.num_shared_convs, self.num_shared_fcs, 
        ...
        self.fc_reg = nn.Linear(self.reg_last_dim, 4 * self.num_classes)
    ...
    def _add_conv_fc_branch(self, num_branch_convs, num_branch_fcs, in_channels, is_shared=False):
        ...
        if num_branch_convs > 0:
            for i in range(num_branch_convs):
                ...
                branch_convs.append(ConvModule(conv_in_channels, self.conv_out_channels, 3, 
                                               padding=1))
...
class Shared2FCBBoxHead(ConvFCBBoxHead):
    ...
    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(Shared2FCBBoxHead, self).__init__(
            num_shared_convs=0, num_shared_fcs=2, 
